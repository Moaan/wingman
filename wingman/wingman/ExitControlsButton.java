...
import static wingman.Wingman.displayControls;
 ...
 * @author Moaan
 */
public class ExitControlsButton extends Wingman implements MenuButton {

    private String label = "Back";
    ...
    public void draw(Graphics2D g, ImageObserver obs, int width, int height) {
        ...
        y = (int) (height - bounds.getHeight())*7/8;
